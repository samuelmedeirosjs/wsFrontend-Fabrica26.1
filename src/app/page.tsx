...
export default function Home() {
  return (
    <main>
      ...
      <section className="w-full h-[calc(100vh-130px)] -mt-10 mb-10 flex items-center max-w-300 flex-col justify-center gap-10 px-6 lg:flex-row lg:items-center lg:justify-between mx-auto">
        <div className="w-1/2 flex flex-col text-left gap-3">
