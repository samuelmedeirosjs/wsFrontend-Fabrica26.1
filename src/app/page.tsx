...
export default function Home() {
  return (
    <main>
      ...
      <section className="w-screen h-[calc(100vh-130px)] md:-mt-10 mb-10 flex items-center max-w-300 flex-col md:flex-row justify-center gap-5 md:gap-10 px-6 lg:flex-row lg:items-center lg:justify-between mx-auto">
